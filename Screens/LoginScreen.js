    ...
    <View style={styles.container}>
      <View style={styles.box}>
        ...
        {<Text style={styles.advertence}>
          {(isCorrecto != null) && (isCorrecto ? "Usuario correcto" : "Credenciales invalidas")}
        </Text>}
        <Button
        ...
        <TouchableOpacity style={styles.googleButton} /*onPress={handleGoogleSignIn}*/>
          ...
          <Text style={styles.googleText}>{googleSignInButtonText}</Text>
              ...
              <Text style={styles.registerText}>{registerText}  <Text style={styles.link} onPress={() => navigation.navigate('Registration')}>{registerLinkText}</Text> </Text>
            </View>
          </View>
        )
      }
